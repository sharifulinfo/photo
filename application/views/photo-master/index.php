         ...
         <div class="col-xs-12 intro">
            <div class="carousel-inner">
               <div class="item active">
                <img class="img-responsive" src="<?php echo $cover->index_pic?>" alt="header picture">
               </div>
               <div class="carousel-caption">
                  <h1><?php echo $cover->index_head;?></h1>
                  <p><?php echo $cover->index_content;?></p>
        ...
        <!-- First Category pictures -->
           <div class="tab-pane active" >
              <div class="row popup-gallery">
                <?php foreach ($allData as $single) {?>
                <div class="col-xs-12 col-sm-6 col-md-4">
                  <div class="sol">
                    <img class="img-responsive" style="height: 230px; width: 100%;" src="<?php echo $single->blog_img?>" alt="First category picture">
                    <div class="behind">
